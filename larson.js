...
function route (container,from_component,mevent) {     /* line 379 */
    ...
    if ((! ( was_sent))) {                             /* line 401 */
      console.log ( "✗" +  ( container.name.toString ()+  ( ": mevent '".toString ()+  ( mevent.port.toString ()+  ( "' from ".toString ()+  ( fromname.toString ()+  " dropped on floor...".toString ()) .toString ()) .toString ()) .toString ()) .toString ()) )/* line 402 *//* line 403 */
    }                                                  /* line 404 *//* line 405 */
}
